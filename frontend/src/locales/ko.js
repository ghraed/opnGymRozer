...
export default {
 ...
 'You still log the total: {0} is {1} per side.': '기록은 그대로 합계로 합니다: {0}회는 한쪽당 {1}회입니다.',
  'Signed in with email and password — data syncs to this profile.': '이메일과 비밀번호로 로그인됨 — 데이터가 이 프로필과 동기화됩니다.',
  '{0} · {1} days per week': '{0} · 주 {1}일',
  'Build muscle': '근육 키우기',
  'Build strength': '근력 키우기',
  'Lose weight': '체중 감량',
  'Gain weight': '체중 증량',
  'General fitness': '종합 체력',
  'Finish your setup for a recommended plan': '추천 계획을 받으려면 설정을 완료하세요',
  'Choose workout program': '운동 프로그램 선택',
 'Rest-timer alerts, even if ROZER is closed.': 'ROZER가 닫혀 있어도 휴식 타이머 알림을 받습니다.',
  'Height (cm)': '키 (cm)',
 'Enter a valid height': '올바른 키를 입력하세요',
  'BMI': 'BMI',
  'Body mass index': '체질량지수',
  'Add your height in Fitness profile to calculate BMI.': 'BMI 계산을 위해 피트니스 프로필에 키를 추가하세요.',
  'Underweight': '저체중',
  'Healthy range': '건강 범위',
  'Overweight': '과체중',
  'Obesity': '비만',
  'Based on {0} {1} and {2} cm': '{0} {1} 및 {2}cm 기준',
  'BMI is a screening measure for adults, not a diagnosis.': 'BMI는 성인 선별 지표이며 진단이 아닙니다.',
