...
export default {
 ...
 'You still log the total: {0} is {1} per side.': 'आप कुल ही दर्ज करते हैं: {0} यानी प्रति तरफ़ {1}।',
  'Signed in with email and password — data syncs to this profile.': 'ईमेल और पासवर्ड से साइन इन है — डेटा इस प्रोफ़ाइल से सिंक होता है।',
  '{0} · {1} days per week': '{0} · सप्ताह में {1} दिन',
  'Build muscle': 'मांसपेशियाँ बनाएँ',
  'Build strength': 'ताकत बढ़ाएँ',
  'Lose weight': 'वज़न घटाएँ',
  'Gain weight': 'वज़न बढ़ाएँ',
  'General fitness': 'सामान्य फ़िटनेस',
  'Finish your setup for a recommended plan': 'सुझाई गई योजना के लिए अपना सेटअप पूरा करें',
  'Choose workout program': 'वर्कआउट प्रोग्राम चुनें',
  'Rest-timer alerts, even if ROZER is closed.': 'ROZER बंद होने पर भी रेस्ट-टाइमर अलर्ट।',
  'Height (cm)': 'ऊँचाई (सेमी)',
 'Enter a valid height': 'सही ऊँचाई दर्ज करें',
  'BMI': 'बीएमआई',
  'Body mass index': 'बॉडी मास इंडेक्स',
  'Add your height in Fitness profile to calculate BMI.': 'बीएमआई निकालने के लिए फ़िटनेस प्रोफ़ाइल में अपनी ऊँचाई जोड़ें।',
  'Underweight': 'कम वज़न',
  'Healthy range': 'स्वस्थ सीमा',
  'Overweight': 'अधिक वज़न',
  'Obesity': 'मोटापा',
  'Based on {0} {1} and {2} cm': '{0} {1} और {2} सेमी के आधार पर',
  'BMI is a screening measure for adults, not a diagnosis.': 'बीएमआई वयस्कों के लिए एक स्क्रीनिंग माप है, निदान नहीं।',
