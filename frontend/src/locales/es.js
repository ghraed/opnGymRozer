...
export default {
 ...
 'You still log the total: {0} is {1} per side.': 'Sigues registrando el total: {0} son {1} por lado.',
  'Signed in with email and password — data syncs to this profile.': 'Sesión iniciada con correo y contraseña — los datos se sincronizan con este perfil.',
  '{0} · {1} days per week': '{0} · {1} días por semana',
  'Build muscle': 'Ganar músculo',
  'Build strength': 'Ganar fuerza',
  'Lose weight': 'Perder peso',
  'Gain weight': 'Ganar peso',
  'General fitness': 'Forma física general',
  'Finish your setup for a recommended plan': 'Completa tu configuración para obtener un plan recomendado',
  'Choose workout program': 'Elegir programa de entrenamiento',
 'Rest-timer alerts, even if ROZER is closed.': 'Alertas del temporizador de descanso, incluso si ROZER está cerrado.',
  'Height (cm)': 'Altura (cm)',
 'Enter a valid height': 'Introduce una altura válida',
  'BMI': 'IMC',
  'Body mass index': 'Índice de masa corporal',
  'Add your height in Fitness profile to calculate BMI.': 'Añade tu altura en el perfil de fitness para calcular el IMC.',
  'Underweight': 'Bajo peso',
  'Healthy range': 'Rango saludable',
  'Overweight': 'Sobrepeso',
  'Obesity': 'Obesidad',
  'Based on {0} {1} and {2} cm': 'Basado en {0} {1} y {2} cm',
  'BMI is a screening measure for adults, not a diagnosis.': 'El IMC es una medida de cribado para adultos, no un diagnóstico.',
