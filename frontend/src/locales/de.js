...
export default {
 ...
 'You still log the total: {0} is {1} per side.': 'Du trägst weiterhin die Gesamtzahl ein: {0} sind {1} pro Seite.',
  'Signed in with email and password — data syncs to this profile.': 'Mit E-Mail und Passwort angemeldet — Daten werden mit diesem Profil synchronisiert.',
  '{0} · {1} days per week': '{0} · {1} Tage pro Woche',
  'Build muscle': 'Muskeln aufbauen',
  'Build strength': 'Kraft aufbauen',
  'Lose weight': 'Abnehmen',
  'Gain weight': 'Zunehmen',
  'General fitness': 'Allgemeine Fitness',
  'Finish your setup for a recommended plan': 'Schließe deine Einrichtung ab, um einen empfohlenen Plan zu erhalten',
  'Choose workout program': 'Trainingsprogramm wählen',
 'Rest-timer alerts, even if ROZER is closed.': 'Pausentimer-Alarme, auch wenn ROZER geschlossen ist.',
  'Height (cm)': 'Größe (cm)',
 'Enter a valid height': 'Gib eine gültige Größe ein',
  'BMI': 'BMI',
  'Body mass index': 'Body-Mass-Index',
  'Add your height in Fitness profile to calculate BMI.': 'Trage deine Größe im Fitnessprofil ein, um den BMI zu berechnen.',
  'Underweight': 'Untergewicht',
  'Healthy range': 'Gesunder Bereich',
  'Overweight': 'Übergewicht',
  'Obesity': 'Adipositas',
  'Based on {0} {1} and {2} cm': 'Basierend auf {0} {1} und {2} cm',
  'BMI is a screening measure for adults, not a diagnosis.': 'Der BMI ist ein Orientierungswert für Erwachsene, keine Diagnose.',
