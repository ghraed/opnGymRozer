...
export default {
 ...
 'You still log the total: {0} is {1} per side.': 'Ты по-прежнему записываешь общее число: {0} — это {1} на сторону.',
  'Signed in with email and password — data syncs to this profile.': 'Вход выполнен по электронной почте и паролю — данные синхронизируются с этим профилем.',
  '{0} · {1} days per week': '{0} · {1} дн. в неделю',
  'Build muscle': 'Набрать мышечную массу',
  'Build strength': 'Развить силу',
  'Lose weight': 'Снизить вес',
  'Gain weight': 'Набрать вес',
  'General fitness': 'Общая физическая форма',
  'Finish your setup for a recommended plan': 'Завершите настройку, чтобы получить рекомендованный план',
  'Choose workout program': 'Выбрать программу тренировок',
 'Rest-timer alerts, even if ROZER is closed.': 'Уведомления таймера отдыха, даже когда ROZER закрыт.',
  'Height (cm)': 'Рост (см)',
 'Enter a valid height': 'Введите корректный рост',
  'BMI': 'ИМТ',
  'Body mass index': 'Индекс массы тела',
  'Add your height in Fitness profile to calculate BMI.': 'Добавьте рост в профиль, чтобы рассчитать ИМТ.',
  'Underweight': 'Недостаточный вес',
  'Healthy range': 'Здоровый диапазон',
  'Overweight': 'Избыточный вес',
  'Obesity': 'Ожирение',
  'Based on {0} {1} and {2} cm': 'На основе {0} {1} и роста {2} см',
  'BMI is a screening measure for adults, not a diagnosis.': 'ИМТ — скрининговый показатель для взрослых, а не диагноз.',
