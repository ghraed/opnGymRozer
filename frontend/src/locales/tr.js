...
export default {
 ...
 'You still log the total: {0} is {1} per side.': 'Toplamı kaydetmeye devam ediyorsun: {0}, taraf başına {1} demek.',
  'Signed in with email and password — data syncs to this profile.': 'E-posta ve parolayla giriş yapıldı — veriler bu profille eşitlenir.',
  '{0} · {1} days per week': '{0} · haftada {1} gün',
  'Build muscle': 'Kas geliştir',
  'Build strength': 'Güç kazan',
  'Lose weight': 'Kilo ver',
  'Gain weight': 'Kilo al',
  'General fitness': 'Genel kondisyon',
  'Finish your setup for a recommended plan': 'Önerilen bir plan için kurulumunu tamamla',
  'Choose workout program': 'Antrenman programı seç',
 'Rest-timer alerts, even if ROZER is closed.': 'ROZER kapalı olsa bile dinlenme sayacı uyarıları.',
  'Height (cm)': 'Boy (cm)',
 'Enter a valid height': 'Geçerli bir boy gir',
  'BMI': 'VKİ',
  'Body mass index': 'Vücut kitle indeksi',
  'Add your height in Fitness profile to calculate BMI.': 'VKİ hesaplamak için Fitness profiline boyunu ekle.',
  'Underweight': 'Düşük kilolu',
  'Healthy range': 'Sağlıklı aralık',
  'Overweight': 'Fazla kilolu',
  'Obesity': 'Obezite',
  'Based on {0} {1} and {2} cm': '{0} {1} ve {2} cm temel alınmıştır',
  'BMI is a screening measure for adults, not a diagnosis.': 'VKİ yetişkinler için bir tarama ölçüsüdür, tanı değildir.',
