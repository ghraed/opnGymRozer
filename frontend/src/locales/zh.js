...
export default {
 ...
 'You still log the total: {0} is {1} per side.': '你记录的仍然是总数：{0} 表示每侧 {1} 次。',
  'Signed in with email and password — data syncs to this profile.': '已使用邮箱和密码登录——数据会同步到此个人资料。',
  '{0} · {1} days per week': '{0} · 每周 {1} 天',
  'Build muscle': '增肌',
  'Build strength': '增强力量',
  'Lose weight': '减重',
  'Gain weight': '增重',
  'General fitness': '综合健身',
  'Finish your setup for a recommended plan': '完成设置以获取推荐计划',
  'Choose workout program': '选择训练计划',
 'Rest-timer alerts, even if ROZER is closed.': '即使 ROZER 已关闭，也会发送休息计时器提醒。',
  'Height (cm)': '身高（厘米）',
 'Enter a valid height': '请输入有效身高',
  'BMI': 'BMI',
  'Body mass index': '身体质量指数',
  'Add your height in Fitness profile to calculate BMI.': '在健身档案中添加身高以计算 BMI。',
  'Underweight': '体重过轻',
  'Healthy range': '健康范围',
  'Overweight': '超重',
  'Obesity': '肥胖',
  'Based on {0} {1} and {2} cm': '根据 {0} {1} 和 {2} 厘米计算',
  'BMI is a screening measure for adults, not a diagnosis.': 'BMI 是成人筛查指标，并非诊断。',
